...
<div class="col-md-2">
	<ul class="list-unstyled mailbox-nav">
		...
		<li class="{{ (Url(Request()->path()) == Url('/subscription/active/users')) ? 'active' : '' }}"><a href="{{Url('/subscription/active/users')}}"><i class="fa fa-inbox"></i>Active User Subscription</a></li>
    ...
    <form action="{{Url('category/upload')}}" method="POST" class="modal-dialog modal-sm" enctype="multipart/form-data">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="mySmallModalLabel">Upload Category</h4>
            </div>
